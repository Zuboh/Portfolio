...
export const projects: Project[] = [
  ...
  },
  {
    ...
    slug: 'primo-contratto',
    description:
      'Upload a contract or payslip — AI reads it, flags issues, and breaks it down in plain language. Built for workers, not lawyers.',
    longDescription:
      'Italian labour law is dense. Primo Contratto takes a contract or payslip photo, extracts the text, and runs it through a prompt that knows Italian employment law. It flags missing clauses, illegal terms, and underpayment — then explains each finding in plain language. No legal jargon.',
    tags: ['React Native', 'Expo', 'OpenAI', 'Supabase'],
    year: 2025,
    status: 'in progress',
    href: '/works/primo-contratto',
    github: 'https://github.com/Zuboh/PrimoContratto',
    whatsnext: [
